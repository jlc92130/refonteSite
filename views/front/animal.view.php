...
<div class='row border border-dark <?php echo ($animal["sexe"] == 1) ? "perso_bgGreen" : "perso_bgPink"; ?> rounded-lg m-2 align-items-center'>
    <div class="col p-2 text-center">
        <img src='<?= URL?>public/src/img/sites/<?php echo $images[0]['url_image'] ?>' class="img-thumbnail" style="max-height:180px;" alt=<?php echo $images[0]['libelle_image'] ?> />
    </div>
        ...
        <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item <?php echo ($key === 0) ? 'active':'' ?> ">
                    <img src="<?= URL?>public/src/img/sites/<?php echo $image['url_image'] ?>" class="img-thumbnail" style=" height:400px;width:400px" alt="<?= $image['libelle_image']?>">
                </div>
                <?php } ?>
            </div>
        </div>       
